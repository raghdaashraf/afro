...
class cpages_list extends cpages {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_pages\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_pages',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fpageslist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
<!--first page button-->
	...
	<a class="btn btn-small" href="<?php echo $pages_list->PageUrl() ?>start=<?php echo $pages_list->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($pages_list->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $pages_list->PageUrl() ?>start=<?php echo $pages_list->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
...
<!--next page button-->
	...
	<a class="btn btn-small" href="<?php echo $pages_list->PageUrl() ?>start=<?php echo $pages_list->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($pages_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $pages_list->PageUrl() ?>start=<?php echo $pages_list->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
...
<?php } ?>
<form name="fpageslist" id="fpageslist" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($pages->_page->Visible) { // page ?>
	<?php if ($pages->SortUrl($pages->_page) == "") { ?>
		<td><div id="elh_pages__page" class="pages__page"><div class="ewTableHeaderCaption"><?php echo $pages->_page->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $pages->SortUrl($pages->_page) ?>',1);"><div id="elh_pages__page" class="pages__page">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $pages->_page->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($pages->_page->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($pages->_page->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($pages->details->Visible) { // details ?>
	<?php if ($pages->SortUrl($pages->details) == "") { ?>
		<td><div id="elh_pages_details" class="pages_details"><div class="ewTableHeaderCaption"><?php echo $pages->details->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $pages->SortUrl($pages->details) ?>',1);"><div id="elh_pages_details" class="pages_details">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $pages->details->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($pages->details->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($pages->details->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<?php echo $pages->_page->ListViewValue() ?></span>
...
<?php echo $pages->details->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
