...
<input type="text" data-field="x_user_name" name="x_user_name" id="x_user_name" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($users->user_name->PlaceHolder) ?>" value="<?php echo $users->user_name->EditValue ?>"<?php echo $users->user_name->EditAttributes() ?>>
</span>
