...
?>
<form name="fslideradd" id="fslideradd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="slider">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_slideradd" class="table table-bordered table-striped">
...
<script type="text/javascript">
ew_CreateEditor("fslideradd", "x_title", 35, 4, <?php echo ($slider->title->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
