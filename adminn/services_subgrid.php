...
<div id="fservices_subgrid" class="ewForm form-inline">
...
<input type="text" data-field="x_name" name="x<?php echo $services_sub_grid->RowIndex ?>_name" id="x<?php echo $services_sub_grid->RowIndex ?>_name" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($services_sub->name->PlaceHolder) ?>" value="<?php echo $services_sub->name->EditValue ?>"<?php echo $services_sub->name->EditAttributes() ?>>
</span>
...
<textarea data-field="x_details" class="editor" name="x<?php echo $services_sub_grid->RowIndex ?>_details" id="x<?php echo $services_sub_grid->RowIndex ?>_details" cols="60" rows="6" placeholder="<?php echo ew_HtmlEncode($services_sub->details->PlaceHolder) ?>"<?php echo $services_sub->details->EditAttributes() ?>><?php echo $services_sub->details->EditValue ?></textarea>
<script type="text/javascript">
