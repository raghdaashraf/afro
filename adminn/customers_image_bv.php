...
$customers_image_blobview = NULL; // Initialize page object first

class ccustomers_image_blobview extends ccustomers {
	...
	// Page object name
	var $PageObjName = 'customers_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('customers', 'x_image');
...
// Create page object
if (!isset($customers_image_blobview)) $customers_image_blobview = new ccustomers_image_blobview();

// Page init
$customers_image_blobview->Page_Init();

// Page main
$customers_image_blobview->Page_Main();
?>
<?php
$customers_image_blobview->Page_Terminate();
?>
