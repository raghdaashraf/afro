...
?>
<form name="fcmsedit" id="fcmsedit" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<textarea data-field="x_desc" class="editor" name="x_desc" id="x_desc" cols="60" rows="4" placeholder="<?php echo ew_HtmlEncode($cms->desc->PlaceHolder) ?>"<?php echo $cms->desc->EditAttributes() ?>><?php echo $cms->desc->EditValue ?></textarea>
<script type="text/javascript">
