...
class cusers_view extends cusers {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_users\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_users',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fusersview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
<!--first page button-->
	...
	<a class="btn btn-small" href="<?php echo $users_view->PageUrl() ?>start=<?php echo $users_view->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($users_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $users_view->PageUrl() ?>start=<?php echo $users_view->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $users_view->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($users_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $users_view->PageUrl() ?>start=<?php echo $users_view->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($users_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $users_view->PageUrl() ?>start=<?php echo $users_view->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $users_view->Pager->PageCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
...
<?php } ?>
<form name="fusersview" id="fusersview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($users->user_name->Visible) { // user_name ?>
	<tr id="r_user_name">
		<td><span id="elh_users_user_name"><?php echo $users->user_name->FldCaption() ?></span></td>
...
<?php echo $users->user_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
