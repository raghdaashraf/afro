...
<?php if ($users->user_name->Visible) { // user_name ?>
		<td><span id="elh_users_user_name" class="users_user_name"><?php echo $users->user_name->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_user_name" class="control-group users_user_name">
