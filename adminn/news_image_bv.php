...
$news_image_blobview = NULL; // Initialize page object first

class cnews_image_blobview extends cnews {
	...
	// Page object name
	var $PageObjName = 'news_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('news', 'x_image');
...
// Create page object
if (!isset($news_image_blobview)) $news_image_blobview = new cnews_image_blobview();

// Page init
$news_image_blobview->Page_Init();

// Page main
$news_image_blobview->Page_Main();
?>
<?php
$news_image_blobview->Page_Terminate();
?>
