...
<input type="text" data-field="x_name" name="x_name" id="x_name" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($contact_form->name->PlaceHolder) ?>" value="<?php echo $contact_form->name->EditValue ?>"<?php echo $contact_form->name->EditAttributes() ?>>
</span>
	</span>
<?php } ?>
</div>
...
<?php if ($contact_form->_email->Visible) { // email ?>
	<span id="xsc__email" class="ewCell">
		...
		<span class="control-group ewSearchField">
<input type="text" data-field="x__email" name="x__email" id="x__email" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($contact_form->_email->PlaceHolder) ?>" value="<?php echo $contact_form->_email->EditValue ?>"<?php echo $contact_form->_email->EditAttributes() ?>>
</span>
	</span>
<?php } ?>
</div>
...
<?php } ?>
<form name="fcontact_formlist" id="fcontact_formlist" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="contact_form">
