...
<div class="ewChangepwdContent">
	<div class="control-group">
		...
		<div class="controls"><input type="password" name="opwd" id="opwd" class="input-large" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("OldPassword")) ?>"></div>
	</div>
	<div class="control-group">
		<label class="control-label" for="npwd"><?php echo $Language->Phrase("NewPassword") ?></label>
		<div class="controls"><input type="password" name="npwd" id="npwd" class="input-large" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("NewPassword")) ?>"></div>
	</div>
	<div class="control-group">
		<label class="control-label" for="cpwd"><?php echo $Language->Phrase("ConfirmPassword") ?></label>
		<div class="controls"><input type="password" name="cpwd" id="cpwd" class="input-large" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("ConfirmPassword")) ?>"></div>
	</div>
	<div class="control-group">
		<div class="controls">
