...
$contact_us_view = NULL; // Initialize page object first

class ccontact_us_view extends ccontact_us {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("contact_uslist.php"); // Return to list page
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_contact_us\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_contact_us',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fcontact_usview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($contact_us_view)) $contact_us_view = new ccontact_us_view();
...
// Form object
var fcontact_usview = new ew_Form("fcontact_usview");

// Form_CustomValidate event
fcontact_usview.Form_CustomValidate = 
...
fcontact_usview.ValidateRequired = true;
<?php } else { ?>
fcontact_usview.ValidateRequired = false; 
<?php } ?>
...
<?php $contact_us_view->ExportOptions->Render("body") ?>
<?php if (!$contact_us_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($contact_us_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $contact_us_view->ShowPageHeader(); ?>
<?php
$contact_us_view->ShowMessage();
?>
<?php if ($contact_us->Export == "") { ?>
<form name="ewPagerForm" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<table class="ewPager">
<tr><td>
<?php if (!isset($contact_us_view->Pager)) $contact_us_view->Pager = new cPrevNextPager($contact_us_view->StartRec, $contact_us_view->DisplayRecs, $contact_us_view->TotalRecs) ?>
<?php if ($contact_us_view->Pager->RecordCount > 0) { ?>
<table class="ewStdTable"><tbody><tr><td>
	<?php echo $Language->Phrase("Page") ?>&nbsp;
<div class="input-prepend input-append">
<!--first page button-->
	<?php if ($contact_us_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $contact_us_view->PageUrl() ?>start=<?php echo $contact_us_view->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($contact_us_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $contact_us_view->PageUrl() ?>start=<?php echo $contact_us_view->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $contact_us_view->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($contact_us_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $contact_us_view->PageUrl() ?>start=<?php echo $contact_us_view->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($contact_us_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $contact_us_view->PageUrl() ?>start=<?php echo $contact_us_view->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $contact_us_view->Pager->PageCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
...
<?php } ?>
<form name="fcontact_usview" id="fcontact_usview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="contact_us">
<table class="ewGrid"><tr><td>
<table id="tbl_contact_usview" class="table table-bordered table-striped">
<?php if ($contact_us->country->Visible) { // country ?>
	<tr id="r_country">
		<td><span id="elh_contact_us_country"><?php echo $contact_us->country->FldCaption() ?></span></td>
...
<?php echo $contact_us->country->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($contact_us->address->Visible) { // address ?>
	<tr id="r_address">
		<td><span id="elh_contact_us_address"><?php echo $contact_us->address->FldCaption() ?></span></td>
...
<?php echo $contact_us->address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($contact_us->first_phone->Visible) { // first_phone ?>
	<tr id="r_first_phone">
		<td><span id="elh_contact_us_first_phone"><?php echo $contact_us->first_phone->FldCaption() ?></span></td>
...
<?php echo $contact_us->first_phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $contact_us->first_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $contact_us->second_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fcontact_usview.Init();
</script>
<?php
$contact_us_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($contact_us->Export == "") { ?>
...
<?php
$contact_us_view->Page_Terminate();
?>
