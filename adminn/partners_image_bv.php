...
$partners_image_blobview = NULL; // Initialize page object first

class cpartners_image_blobview extends cpartners {
	...
	// Page object name
	var $PageObjName = 'partners_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('partners', 'x_image');
...
// Create page object
if (!isset($partners_image_blobview)) $partners_image_blobview = new cpartners_image_blobview();

// Page init
$partners_image_blobview->Page_Init();

// Page main
$partners_image_blobview->Page_Main();
?>
<?php
$partners_image_blobview->Page_Terminate();
?>
