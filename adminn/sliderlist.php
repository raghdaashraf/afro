...
<input type="text" data-field="x_title" name="x_title" id="x_title" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($slider->title->PlaceHolder) ?>" value="<?php echo $slider->title->EditValue ?>"<?php echo $slider->title->EditAttributes() ?>>
<script type="text/javascript">
...
<?php } ?>
<form name="fsliderlist" id="fsliderlist" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="slider">
