...
class ccustomers_view extends ccustomers {
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			// image
			$this->image->UploadPath = '../includes/upload/customers';
...
<table class="ewPager">
<tr><td>
<?php if (!isset($customers_view->Pager)) $customers_view->Pager = new cPrevNextPager($customers_view->StartRec, $customers_view->DisplayRecs, $customers_view->TotalRecs) ?>
<?php if ($customers_view->Pager->RecordCount > 0) { ?>
<table class="ewStdTable"><tbody><tr><td>
	<?php echo $Language->Phrase("Page") ?>&nbsp;
<div class="input-prepend input-append">
<!--first page button-->
	<?php if ($customers_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $customers_view->PageUrl() ?>start=<?php echo $customers_view->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($customers_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $customers_view->PageUrl() ?>start=<?php echo $customers_view->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $customers_view->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($customers_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $customers_view->PageUrl() ?>start=<?php echo $customers_view->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($customers_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $customers_view->PageUrl() ?>start=<?php echo $customers_view->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $customers_view->Pager->PageCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
...
<?php } ?>
<form name="fcustomersview" id="fcustomersview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="customers">
<table class="ewGrid"><tr><td>
<table id="tbl_customersview" class="table table-bordered table-striped">
<?php if ($customers->image->Visible) { // image ?>
	<tr id="r_image">
		<td><span id="elh_customers_image"><?php echo $customers->image->FldCaption() ?></span></td>
		<td<?php echo $customers->image->CellAttributes() ?>>
<span id="el_customers_image" class="control-group">
<span>
<?php if ($customers->image->LinkAttributes() <> "") { ?>
<?php if (!empty($customers->image->Upload->DbValue)) { ?>
<img src="<?php echo $customers->image->ViewValue ?>" alt=""<?php echo $customers->image->ViewAttributes() ?>>
<?php } elseif (!in_array($customers->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } else { ?>
<?php if (!empty($customers->image->Upload->DbValue)) { ?>
