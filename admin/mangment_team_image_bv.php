...
$mangment_team_image_blobview = NULL; // Initialize page object first

class cmangment_team_image_blobview extends cmangment_team {
	...
	// Page object name
	var $PageObjName = 'mangment_team_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('mangment_team', 'x_image');
...
// Create page object
if (!isset($mangment_team_image_blobview)) $mangment_team_image_blobview = new cmangment_team_image_blobview();

// Page init
$mangment_team_image_blobview->Page_Init();

// Page main
$mangment_team_image_blobview->Page_Main();
?>
<?php
$mangment_team_image_blobview->Page_Terminate();
?>
