...
$success_stories_grid = NULL; // Initialize page object first

class csuccess_stories_grid extends csuccess_stories {
	...
	// Page object name
	var $PageObjName = 'success_stories_grid';

	// Grid form hidden field names
	var $FormName = 'fsuccess_storiesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["success_stories"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_id_services") && $objForm->HasValue("o_id_services") && $this->id_services->CurrentValue <> $this->id_services->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_scope") && $objForm->HasValue("o_scope") && $this->scope->CurrentValue <> $this->scope->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->id_services->setOldValue($objForm->GetValue("o_id_services"));
		if (!$this->scope->FldIsDetailKey) {
			$this->scope->setFormValue($objForm->GetValue("x_scope"));
		}
		$this->scope->setOldValue($objForm->GetValue("o_scope"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "services") {
			...
			if ($GLOBALS["services"]->EventCancelled) $this->EventCancelled = TRUE;
		}
