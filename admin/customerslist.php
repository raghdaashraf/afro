...
class ccustomers_list extends ccustomers {
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" href=\"\" onclick=\"ew_SubmitSelected(document.fcustomerslist, '" . $this->MultiDeleteUrl . "');return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_customers\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_customers',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fcustomerslist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
<?php } ?>
<form name="fcustomerslist" id="fcustomerslist" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($customers->image->Visible) { // image ?>
	<?php if ($customers->SortUrl($customers->image) == "") { ?>
		<td><div id="elh_customers_image" class="customers_image"><div class="ewTableHeaderCaption"><?php echo $customers->image->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $customers->SortUrl($customers->image) ?>',1);"><div id="elh_customers_image" class="customers_image">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $customers->image->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($customers->image->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($customers->image->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<img src="<?php echo $customers->image->ListViewValue() ?>" alt=""<?php echo $customers->image->ViewAttributes() ?>>
