...
<?php if ($customers->image->Visible) { // image ?>
		<td><span id="elh_customers_image" class="customers_image"><?php echo $customers->image->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $customers_delete->RowCnt ?>_customers_image" class="control-group customers_image">
<span>
