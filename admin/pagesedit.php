...
class cpages_edit extends cpages {
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->_page->PlaceHolder = ew_HtmlEncode(ew_RemoveHtml($this->_page->FldCaption()));
...
<input type="text" data-field="x__page" name="x__page" id="x__page" size="30" maxlength="255" placeholder="<?php echo $pages->_page->PlaceHolder ?>" value="<?php echo $pages->_page->EditValue ?>"<?php echo $pages->_page->EditAttributes() ?>>
</span>
...
<textarea data-field="x_details" class="editor" name="x_details" id="x_details" cols="35" rows="4" placeholder="<?php echo $pages->details->PlaceHolder ?>"<?php echo $pages->details->EditAttributes() ?>><?php echo $pages->details->EditValue ?></textarea>
<script type="text/javascript">
