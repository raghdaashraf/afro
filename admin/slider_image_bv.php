...
$slider_image_blobview = NULL; // Initialize page object first

class cslider_image_blobview extends cslider {
	...
	// Page object name
	var $PageObjName = 'slider_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('slider', 'x_image');
...
// Create page object
if (!isset($slider_image_blobview)) $slider_image_blobview = new cslider_image_blobview();

// Page init
$slider_image_blobview->Page_Init();

// Page main
$slider_image_blobview->Page_Main();
?>
<?php
$slider_image_blobview->Page_Terminate();
?>
