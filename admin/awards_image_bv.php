...
$awards_image_blobview = NULL; // Initialize page object first

class cawards_image_blobview extends cawards {
	...
	// Page object name
	var $PageObjName = 'awards_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('awards', 'x_image');
...
// Create page object
if (!isset($awards_image_blobview)) $awards_image_blobview = new cawards_image_blobview();

// Page init
$awards_image_blobview->Page_Init();

// Page main
$awards_image_blobview->Page_Main();
?>
<?php
$awards_image_blobview->Page_Terminate();
?>
