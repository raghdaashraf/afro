...
<div id="fsuccess_storiesgrid" class="ewForm form-horizontal">
...
<textarea data-field="x_scope" class="editor" name="x<?php echo $success_stories_grid->RowIndex ?>_scope" id="x<?php echo $success_stories_grid->RowIndex ?>_scope" cols="60" rows="6" placeholder="<?php echo $success_stories->scope->PlaceHolder ?>"<?php echo $success_stories->scope->EditAttributes() ?>><?php echo $success_stories->scope->EditValue ?></textarea>
<script type="text/javascript">
...
<input type="text" data-field="x_customer" name="x<?php echo $success_stories_grid->RowIndex ?>_customer" id="x<?php echo $success_stories_grid->RowIndex ?>_customer" size="30" maxlength="255" placeholder="<?php echo $success_stories->customer->PlaceHolder ?>" value="<?php echo $success_stories->customer->EditValue ?>"<?php echo $success_stories->customer->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_date" name="x<?php echo $success_stories_grid->RowIndex ?>_date" id="x<?php echo $success_stories_grid->RowIndex ?>_date" size="30" maxlength="255" placeholder="<?php echo $success_stories->date->PlaceHolder ?>" value="<?php echo $success_stories->date->EditValue ?>"<?php echo $success_stories->date->EditAttributes() ?>>
</span>
