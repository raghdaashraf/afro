...
define("EW_PROJECT_NAME", "afro", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{742A973F-A49A-4C05-916C-F0633D60D6E6}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '9UKSscZIF6lXEhkT', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/afro.css", TRUE); // Project stylesheet file name
...
*/
define("EW_REMOVE_XSS", FALSE, TRUE);
...
// File upload
define("EW_UPLOAD_DEST_PATH", "../includes/uploads/", TRUE); // Upload destination path (relative to app root)
...
define("EW_MENUBAR_CLASSNAME", "navbar", TRUE);
define("EW_MENUBAR_INNER_CLASSNAME", "navbar-inner", TRUE);
define("EW_MENU_CLASSNAME", "nav", TRUE);
