...
$services_sub_edit = NULL; // Initialize page object first

class cservices_sub_edit extends cservices_sub {
	...
	// Page object name
	var $PageObjName = 'services_sub_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->id_sub->CurrentValue == "")
			$this->Page_Terminate("services_sublist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// id_services
			$this->id_services->SetDbValueDef($rsnew, $this->id_services->CurrentValue, NULL, $this->id_services->ReadOnly);
...
// Create page object
if (!isset($services_sub_edit)) $services_sub_edit = new cservices_sub_edit();

// Page init
$services_sub_edit->Page_Init();

// Page main
$services_sub_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$services_sub_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var services_sub_edit = new ew_Page("services_sub_edit");
services_sub_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = services_sub_edit.PageID; // For backward compatibility

// Form object
var fservices_subedit = new ew_Form("fservices_subedit");

// Validate form
fservices_subedit.Validate = function() {
...
fservices_subedit.Form_CustomValidate = 
...
fservices_subedit.ValidateRequired = true;
<?php } else { ?>
fservices_subedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fservices_subedit.Lists["x_id_services"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $services_sub_edit->ShowPageHeader(); ?>
<?php
$services_sub_edit->ShowMessage();
?>
<form name="fservices_subedit" id="fservices_subedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="services_sub">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_services_subedit" class="table table-bordered table-striped">
...
<script type="text/javascript">
fservices_subedit.Lists["x_id_services"].Options = <?php echo (is_array($services_sub->id_services->EditValue)) ? ew_ArrayToJson($services_sub->id_services->EditValue, 1) : "[]" ?>;
</script>
<?php } ?>
...
<script type="text/javascript">
ew_CreateEditor("fservices_subedit", "x_details", 60, 6, <?php echo ($services_sub->details->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<input type="hidden" data-field="x_id_sub" name="x_id_sub" id="x_id_sub" value="<?php echo ew_HtmlEncode($services_sub->id_sub->CurrentValue) ?>">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("EditBtn") ?></button>
</form>
<script type="text/javascript">
fservices_subedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$services_sub_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$services_sub_edit->Page_Terminate();
?>
