...
<input type="text" data-field="x_scope" name="x_scope" id="x_scope" placeholder="<?php echo $success_stories->scope->PlaceHolder ?>" value="<?php echo $success_stories->scope->EditValue ?>"<?php echo $success_stories->scope->EditAttributes() ?>>
<script type="text/javascript">
...
<input type="text" data-field="x_date" name="y_date" id="y_date" size="30" maxlength="255" placeholder="<?php echo $success_stories->date->PlaceHolder ?>" value="<?php echo $success_stories->date->EditValue2 ?>"<?php echo $success_stories->date->EditAttributes() ?>>
</span>
	</span>
<?php } ?>
</div>
...
<?php } ?>
<form name="fsuccess_storieslist" id="fsuccess_storieslist" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="success_stories">
