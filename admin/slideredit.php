...
?>
<form name="fslideredit" id="fslideredit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<textarea data-field="x_title" class="editor" name="x_title" id="x_title" cols="35" rows="4" placeholder="<?php echo $slider->title->PlaceHolder ?>"<?php echo $slider->title->EditAttributes() ?>><?php echo $slider->title->EditValue ?></textarea>
<script type="text/javascript">
...
<div id="el_slider_image" class="control-group">
<span id="fd_x_image">
