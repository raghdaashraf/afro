...
class cusers_add extends cusers {
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->user_name->PlaceHolder = ew_HtmlEncode(ew_RemoveHtml($this->user_name->FldCaption()));
...
<input type="text" data-field="x_user_name" name="x_user_name" id="x_user_name" size="30" maxlength="255" placeholder="<?php echo $users->user_name->PlaceHolder ?>" value="<?php echo $users->user_name->EditValue ?>"<?php echo $users->user_name->EditAttributes() ?>>
</span>
