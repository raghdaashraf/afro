...
class cservices_view extends cservices {
	...
	function SetupOtherOptions() {
		...
		// Detail table 'services_sub'
		$body = $Language->TablePhrase("services_sub", "TblCaption");
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("services_sublist.php?" . EW_TABLE_SHOW_MASTER . "=services&id=" . strval($this->id->CurrentValue) . "") . "\">" . $body . "</a>";
		$item = &$option->Add("detail_services_sub");
		$item->Body = $body;
		...
		// Detail table 'success_stories'
		$body = $Language->TablePhrase("success_stories", "TblCaption");
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("success_storieslist.php?" . EW_TABLE_SHOW_MASTER . "=services&id=" . strval($this->id->CurrentValue) . "") . "\">" . $body . "</a>";
		$item = &$option->Add("detail_success_stories");
		$item->Body = $body;
		$item->Visible = $Security->IsLoggedIn();
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("services_sub", $DetailTblVar)) {
				...
				if ($GLOBALS["services_sub_grid"]->DetailView) {
					$GLOBALS["services_sub_grid"]->CurrentMode = "view";
			...
			if (in_array("success_stories", $DetailTblVar)) {
				...
				if ($GLOBALS["success_stories_grid"]->DetailView) {
					$GLOBALS["success_stories_grid"]->CurrentMode = "view";
...
// Page object
var services_view = new ew_Page("services_view");
services_view.PageID = "view"; // Page ID
var EW_PAGE_ID = services_view.PageID; // For backward compatibility

// Form object
var fservicesview = new ew_Form("fservicesview");
...
<?php if (!$services_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
<table class="ewPager">
<tr><td>
<?php if (!isset($services_view->Pager)) $services_view->Pager = new cPrevNextPager($services_view->StartRec, $services_view->DisplayRecs, $services_view->TotalRecs) ?>
<?php if ($services_view->Pager->RecordCount > 0) { ?>
<table class="ewStdTable"><tbody><tr><td>
	<?php echo $Language->Phrase("Page") ?>&nbsp;
<div class="input-prepend input-append">
<!--first page button-->
	<?php if ($services_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($services_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $services_view->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($services_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($services_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $services_view->PageUrl() ?>start=<?php echo $services_view->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $services_view->Pager->PageCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
...
<?php } ?>
<form name="fservicesview" id="fservicesview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="services">
<table class="ewGrid"><tr><td>
<table id="tbl_servicesview" class="table table-bordered table-striped">
<?php if ($services->title->Visible) { // title ?>
	<tr id="r_title">
		<td><span id="elh_services_title"><?php echo $services->title->FldCaption() ?></span></td>
...
<?php echo $services->title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->desc->Visible) { // desc ?>
	<tr id="r_desc">
		<td><span id="elh_services_desc"><?php echo $services->desc->FldCaption() ?></span></td>
...
<?php echo $services->desc->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<div class="tabbable" id="services_view_details">
	<ul class="nav nav-tabs">
<?php
	if (in_array("services_sub", explode(",", $services->getCurrentDetailTable())) && $services_sub->DetailView) {
...
?>
<?php
	if (in_array("success_stories", explode(",", $services->getCurrentDetailTable())) && $success_stories->DetailView) {
