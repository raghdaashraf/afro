...
<?php if ($news->details->Visible) { // details ?>
		<td><span id="elh_news_details" class="news_details"><?php echo $news->details->FldCaption() ?></span></td>
<?php } ?>
<?php if ($news->date->Visible) { // date ?>
		<td><span id="elh_news_date" class="news_date"><?php echo $news->date->FldCaption() ?></span></td>
<?php } ?>
<?php if ($news->image->Visible) { // image ?>
		<td><span id="elh_news_image" class="news_image"><?php echo $news->image->FldCaption() ?></span></td>
<?php } ?>
...
<span id="el<?php echo $news_delete->RowCnt ?>_news_details" class="control-group news_details">
...
<span id="el<?php echo $news_delete->RowCnt ?>_news_date" class="control-group news_date">
...
<span id="el<?php echo $news_delete->RowCnt ?>_news_image" class="control-group news_image">
<span>
...
<span id="el<?php echo $news_delete->RowCnt ?>_news_status" class="control-group news_status">
