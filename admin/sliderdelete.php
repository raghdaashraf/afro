...
// Form object
var fsliderdelete = new ew_Form("fsliderdelete");
...
if ($slider_delete->Recordset = $slider_delete->LoadRecordset())
	$slider_deleteTotalRecs = $slider_delete->Recordset->RecordCount(); // Get record count
if ($slider_deleteTotalRecs <= 0) { // No record found, exit
	if ($slider_delete->Recordset)
...
?>
<form name="fsliderdelete" id="fsliderdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_sliderdelete" class="ewTable ewTableSeparate">
<?php echo $slider->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($slider->id->Visible) { // id ?>
		<td><span id="elh_slider_id" class="slider_id"><?php echo $slider->id->FldCaption() ?></span></td>
<?php } ?>
<?php if ($slider->title->Visible) { // title ?>
		<td><span id="elh_slider_title" class="slider_title"><?php echo $slider->title->FldCaption() ?></span></td>
<?php } ?>
<?php if ($slider->image->Visible) { // image ?>
		<td><span id="elh_slider_image" class="slider_image"><?php echo $slider->image->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $slider_delete->RowCnt ?>_slider_id" class="control-group slider_id">
...
<span id="el<?php echo $slider_delete->RowCnt ?>_slider_title" class="control-group slider_title">
...
<span id="el<?php echo $slider_delete->RowCnt ?>_slider_image" class="control-group slider_image">
<span>
