...
class cnews_view extends cnews {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_news\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_news',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fnewsview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
<!--first page button-->
	...
	<a class="btn btn-small" href="<?php echo $news_view->PageUrl() ?>start=<?php echo $news_view->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($news_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $news_view->PageUrl() ?>start=<?php echo $news_view->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
...
<!--next page button-->
	...
	<a class="btn btn-small" href="<?php echo $news_view->PageUrl() ?>start=<?php echo $news_view->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($news_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $news_view->PageUrl() ?>start=<?php echo $news_view->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
...
<?php if ($news->details->Visible) { // details ?>
	<tr id="r_details">
		<td><span id="elh_news_details"><?php echo $news->details->FldCaption() ?></span></td>
...
<?php echo $news->details->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span id="el_news_image" class="control-group">
<span>
<?php if ($news->image->LinkAttributes() <> "") { ?>
<?php if (!empty($news->image->Upload->DbValue)) { ?>
<img src="<?php echo $news->image->ViewValue ?>" alt=""<?php echo $news->image->ViewAttributes() ?>>
...
<?php if ($news->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_news_status"><?php echo $news->status->FldCaption() ?></span></td>
