...
?>
<form name="fservicesdelete" id="fservicesdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_servicesdelete" class="ewTable ewTableSeparate">
<?php echo $services->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($services->title->Visible) { // title ?>
		<td><span id="elh_services_title" class="services_title"><?php echo $services->title->FldCaption() ?></span></td>
<?php } ?>
<?php if ($services->desc->Visible) { // desc ?>
		<td><span id="elh_services_desc" class="services_desc"><?php echo $services->desc->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $services_delete->RowCnt ?>_services_title" class="control-group services_title">
...
<span id="el<?php echo $services_delete->RowCnt ?>_services_desc" class="control-group services_desc">
