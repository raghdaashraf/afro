...
$success_stories_add = NULL; // Initialize page object first

class csuccess_stories_add extends csuccess_stories {
	...
	// Page object name
	var $PageObjName = 'success_stories_add';
	...
	function LoadDefaultValues() {
		...
		$this->id_services->OldValue = $this->id_services->CurrentValue;
		$this->scope->CurrentValue = NULL;
		$this->scope->OldValue = $this->scope->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		if (strval($this->id_services->CurrentValue) <> "") {
			$sMasterFilter = str_replace("@id@", ew_AdjustSql($this->id_services->CurrentValue), $sMasterFilter);
		} else {
		...
		// id_services
		$this->id_services->SetDbValueDef($rsnew, $this->id_services->CurrentValue, 0, FALSE);

		// scope
		$this->scope->SetDbValueDef($rsnew, $this->scope->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($success_stories_add)) $success_stories_add = new csuccess_stories_add();

// Page init
$success_stories_add->Page_Init();

// Page main
$success_stories_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$success_stories_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var success_stories_add = new ew_Page("success_stories_add");
success_stories_add.PageID = "add"; // Page ID
var EW_PAGE_ID = success_stories_add.PageID; // For backward compatibility

// Form object
var fsuccess_storiesadd = new ew_Form("fsuccess_storiesadd");

// Validate form
fsuccess_storiesadd.Validate = function() {
...
fsuccess_storiesadd.Form_CustomValidate = 
...
fsuccess_storiesadd.ValidateRequired = true;
<?php } else { ?>
fsuccess_storiesadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fsuccess_storiesadd.Lists["x_id_services"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $success_stories_add->ShowPageHeader(); ?>
<?php
$success_stories_add->ShowMessage();
?>
<form name="fsuccess_storiesadd" id="fsuccess_storiesadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="success_stories">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_success_storiesadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fsuccess_storiesadd.Lists["x_id_services"].Options = <?php echo (is_array($success_stories->id_services->EditValue)) ? ew_ArrayToJson($success_stories->id_services->EditValue, 1) : "[]" ?>;
</script>
<?php } ?>
...
<script type="text/javascript">
ew_CreateEditor("fsuccess_storiesadd", "x_scope", 60, 6, <?php echo ($success_stories->scope->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<script type="text/javascript">
fsuccess_storiesadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$success_stories_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$success_stories_add->Page_Terminate();
?>
