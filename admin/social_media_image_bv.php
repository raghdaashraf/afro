...
$social_media_image_blobview = NULL; // Initialize page object first

class csocial_media_image_blobview extends csocial_media {
	...
	// Page object name
	var $PageObjName = 'social_media_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('social_media', 'x_image');
...
// Create page object
if (!isset($social_media_image_blobview)) $social_media_image_blobview = new csocial_media_image_blobview();

// Page init
$social_media_image_blobview->Page_Init();

// Page main
$social_media_image_blobview->Page_Main();
?>
<?php
$social_media_image_blobview->Page_Terminate();
?>
