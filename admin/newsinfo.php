...
class cnews extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('news', 'news', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title
		$this->title = new cField('news', 'news', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title'] = &$this->title;

		// details
		$this->details = new cField('news', 'news', 'x_details', 'details', '`details`', '`details`', 201, -1, FALSE, '`details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['details'] = &$this->details;

		// date
		$this->date = new cField('news', 'news', 'x_date', 'date', '`date`', 'DATE_FORMAT(`date`, \'%Y-%m-%d\')', 135, 5, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->date->FldDefaultErrMsg = str_replace("%s", "-", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['date'] = &$this->date;

		// image
		$this->image = new cField('news', 'news', 'x_image', 'image', '`image`', '`image`', 200, -1, TRUE, '`image`', FALSE, FALSE, FALSE, 'IMAGE');
		$this->fields['image'] = &$this->image;

		// status
		$this->status = new cField('news', 'news', 'x_status', 'status', '`status`', '`status`', 202, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
